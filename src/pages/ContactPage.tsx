            ...
            <form className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  ...
                  <input type="text" className="w-full bg-[#151515] border border-white/10 rounded-sm px-6 py-4 text-[15px] text-white focus:outline-none focus:border-primary focus:bg-transparent transition-all duration-300 placeholder:text-white/20" placeholder="John Doe" />
                </div>
                <div className="space-y-3">
              ...
              <div className="space-y-3">
                ...
                <input type="tel" className="w-full bg-[#151515] border border-white/10 rounded-sm px-6 py-4 text-[15px] text-white focus:outline-none focus:border-primary focus:bg-transparent transition-all duration-300 placeholder:text-white/20" placeholder="+91 99000 00000" />
              </div>
              <div className="space-y-3">
                <label className="text-[11px] font-display font-bold text-white/60 uppercase tracking-widest">Message</label>
                <textarea rows={5} className="w-full bg-[#151515] border border-white/10 rounded-sm px-6 py-4 text-[15px] text-white focus:outline-none focus:border-primary focus:bg-transparent transition-all duration-300 resize-none placeholder:text-white/20" placeholder="Tell us about your project..."></textarea>
              </div>
